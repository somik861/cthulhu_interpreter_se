...
class IInterpreter {
  public:
     ...
     */
    virtual void addBuiltin(std::string_view name, std::unique_ptr<builtins::IBuiltin> builtin) = 0;
     ...
     */
    virtual void initExecution(std::unique_ptr<parser::IProgramCode> code, std::ostream* log_stream = nullptr) = 0;
